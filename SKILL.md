...
[![Version](https://img.shields.io/badge/version-2.5-blue)](https://github.com/qq547820639/tiktok-ad-video-skill)
...
| `references/cinematic-vocabulary.md` | 五维架构词汇表 + 混写指南 + 原生感默认词汇包 | 强烈推荐 |
| `references/evaluation-rubric.md` | 五维度评分标准 + 失败模式速查表 | 强烈推荐 |
| `references/platform-specs.md` | 2026 各平台算法规则、分阶段测试分发、TikTok SEO | 推荐 |
...
| **新视频播放量卡在几百** | TikTok 分阶段测试分发，前3秒表现决定能否突破测试池，优化前3秒冲击力 |
| **TikTok 搜索流量少** | 标题和字幕加入核心关键词，评论区置顶重复关键词 |
| **Instagram 推荐少** | 保持每日1-3条发布频率，获取“当日发布优先”推荐 |
| **AI 味太重，像广告** | 启用原生感默认策略：`真实素人反应 (Authentic unscripted reaction)` / `自然窗光 (Natural window light)` |
...
| 更新项 | 说明 |
| :--- | :--- |
| 🔄 **分阶段测试分发逻辑修正** | 修正 TikTok 分发逻辑：新视频先进入 300-500 人兴趣匹配测试池，而非“粉丝优先” |
| 💎 **社交货币分享体系** | 分享引导升级为三类社交货币：展现品味型、展示专业型、圈层归属型 |
| 🤳 **原生感默认策略** | 原生感（UGC风格）从可选升级为默认推荐，对齐 2026 AI 广告趋势 |
| 🌐 **中英文混写提示词** | 全部示例增加混写版变体（中文意境 + 英文精准指令），充分利用 Seedance 2.0 双语优势 |
| 🖼️ **多模态参考素材指南** | 新增参考图/视频准备指南，支持上传最多 12 个多模态参考文件 |
| 📈 **TikTok SEO 策略** | 新增标题、字幕、评论区关键词优化指南，对齐短视频成为 Z 世代首选搜索引擎 |
| ⏰ **Instagram 当日发布优先** | 新增 Meta 算法优先推荐当日发布内容的策略说明 |
...
└── references/
    ...
    ├── cinematic-vocabulary.md      # 🎬 五维架构词汇 + 混写指南 + 原生感默认词汇
    ├── platform-specs.md            # 📱 2026 平台算法 + 分阶段测试 + TikTok SEO
...
**记住**：不浪费积分，先测钩子再生成。品类匹配多镜头，混写提示出质感。原生感为默认，社交货币定乾坤。
