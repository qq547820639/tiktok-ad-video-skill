...
> **合并自**：原 `references/` 目录下 12 个文件的核心内容，包括 `localization-guide.md`、`localization-script-guide.md` 等。
> **版本**：v3.0 (2026.05) —— 合并 localization-guide.md 的节日日历、价值观策略、色彩文化禁忌等差异化内容。
...
- [ ] 转化路径是否符合目标市场电商生态？
- [ ] 是否有文化禁忌词汇？
- [ ] 是否临近目标市场核心节日？（对照 §5.3 节日日历）
- [ ] 叙事策略是否适配目标市场价值观？（对照 §5.4）
...
| 国家/地区 | 内容禁忌 | 特殊规定 |
| :--- | :--- | :--- |
| **中东（沙特、阿联酋）** | 女性暴露（肩膀、膝盖以上）、酒精、猪肉、宗教符号滥用 | 斋月期间日间不得出现饮食画面 |
| **东南亚（印尼、马来西亚）** | 左手递物、脚底对人、猪相关形象 | 印尼要求 30% 以上内容为本地制作（部分品类） |
| **印度** | 牛肉、皮革制品（涉及牛）、宗教讽刺 | 需标注“广告”字样 |
| **欧盟** | 儿童隐私、环保声明需可验证 | GDPR 合规：定向广告需获得明确同意 |
| **日本** | 过度直接的价格对比、贬低竞品 | “お得”需有真实价格对比支撑 |
| **韩国** | 过度夸张的承诺、未经证实的“第一名”宣称 | 需标注“广告”或“협찬” |


**版本更新记录**：
- v3.0 (2026.05)：合并原 `localization-guide.md` 的差异化内容（§5.3 节日日历、§5.4 价值观策略、§5.7 内容禁忌）；合并原 `localization-script-guide.md` 的语言脚本内容（§5.1 本土化速查、§5.2 情绪词、§5.5 自检清单、§5.6 色彩差异）。同时更新 §5.5 自检清单，增加节日检查和价值观检查项。
